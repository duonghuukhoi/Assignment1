...
//        Student s = new Student(studentEnrolment.get(0).get(0).toString(),studentEnrolment.get(0).get(1).toString(),sdf.parse(studentEnrolment.get(0).get(2)));
...
//        }
    ...
    public static ArrayList<Student> addStudent (List<List<String>> enrolmentList) throws ParseException{
        ...
        for (int i =0 ; i <enrolmentList.size() ; i++){
            Student s = new Student(enrolmentList.get(i).get(0).toString(),enrolmentList.get(i).get(1).toString(),sdf.parse(enrolmentList.get(i).get(2)));
            System.out.println(s.toString());
